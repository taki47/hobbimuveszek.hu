        ...
        <div class="modal-dialog modal-dialog-centered login-modal" role="document">
            <div class="modal-content">
                <div class="auth-box">
                    ...
                    <!-- form start -->
                    <form id="form_login" novalidate="novalidate" method="POST" action="{{ route('loginAttempt') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="password" name="password" class="form-control auth-form-input" value="" placeholder="{{ __('auth.login.password') }}" minlength="4" required="" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
                        </div>
                        ...
                        <p class="p-social-media m-0 m-t-5"><a href="{{ route('register') }}" class="link">{{ __('auth.login.register') }}</a></p>
                    </form>
                    <!-- form end -->
                </div>
            </div>
